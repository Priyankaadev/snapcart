...
import groceries from '../assets/grocery.jpg'
 ...
 const slides = [
          {
            ...
            subtitle:"Farm-fresh fruits, veetables, and daily essentials delivered to you.",
            btnText: "Shop Now",
            bg: groceries,
          },
          {
...
const HeroSection = () => {
  ...
  return (
    <div className='relative w-[98%] mx-auto mt-32 h-[80vh] rounded-3xl overflow-hidden shadow-2xl'>
      ...
      <div className='absolute bottom-6 left-[47%] -translate-x-0.5 flex gap-3'>
      {slides.map((_,index)=>(
        <button
        key={index}
